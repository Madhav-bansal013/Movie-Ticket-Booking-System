...
public:
    ...
    void hal_name()
    {
        switch(obn)
        {
            ...
            break;
             case 2:
            hall_name="CARNIVAL CINEMAS";
            break;
             case 3:
            hall_name="INOX OMAXE";
            break;
             case 4:
            hall_name="WAVE CINEMAS";
            break;
        }
...
int main()
{
 ...
 //syestem("cls");
    while(1)
    {
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 1 TO BOOK TICKET IN PVR LOGIX";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 2 TO BOOK TICKET IN CARNIVAL CINEMAS";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 3 TO BOOK TICKET IN INOX ONAXE";
    cout<<"\n\n\t\t\t\t\t\t\t PRESS 4 TO BOOK TICKET IN  WAVE CINEMAS";
    ...
    switch(obn)
    {
        case 1:
            cout<<"\t\t\t\t\t\t\t";
            cout<<"PVR LOGIX IS SELECTED\n";
        obj[0].first();
        break;
        case 2:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"CARNIVAL CINEMAS IS SELECTED\n";
        obj[1].first();
        break;
        case 3:
        cout<<"\t\t\t\t\t\t\t";
             cout<<"INOX OMAXE IS SELECTED\n";
        obj[2].first();
        break;
        case 4:
        cout<<"\t\t\t\t\t\t\t";
            cout<<"WAVE CINEMAS IS SELECTED\n";
        obj[3].first();
        break;
        case 9:
                goto bye;
